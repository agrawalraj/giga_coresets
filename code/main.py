...
########## Adult ################### 
sparse_mat = load_svmlight_file('a9a')
...
for i in range(20):
	...
	pickle.dump(result, open( "../data/adult/adult_5k_20k_iter_{}.p".format(i), "wb" ) )
	results.append(result)

######## Sensorless ################### 
sparse_mat = load_svmlight_file('Sensorless.scale') 
X = sparse_mat[0].todense() 
y = sparse_mat[1] 
y = np.array(y, dtype=np.int32)
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.2, random_state = 0)
...
for i in range(20):
	...
	pickle.dump(result, open( "../data/sensorless_results/sensorless_5k_20k_iter_{}.p".format(i), "wb" ) )
	results.append(result)
...
for i in range(20):
	...
	pickle.dump(result, open( "../data/human_activity/human_activity_5k_20k_iter_{}.p".format(i), "wb" ) )
	results.append(result)
...
for i in range(7, 100):
	...
	pickle.dump(result, open( "../data/mnist/mnist_5k_20k_iter_{}.p".format(i), "wb" ) )
